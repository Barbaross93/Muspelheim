theme = [
    ...
    ('list-header-column-separator', 'black',
     'light gray', '', 'black', 'light gray'),
    ('striped-table-row', 'white', 'dark gray', '', 'white', 'black'),
    ('reveal focus', 'black', 'dark red', 'standout', 'black', 'yellow'),
    ('message status', 'white', 'dark blue', 'standout', 'white', 'dark blue'),
    ('message error', 'white', 'dark red', 'standout', 'white', 'dark red'),
    ('status', 'dark magenta', 'black', '', 'dark red', 'black'),
