...
dtl() {
	...
	sed -i 's|#include "/home/barbaross/.config/x11/colorschemes/gruvbox-dark"|#include "/home/barbaross/.config/x11/colorschemes/gruvbox-light"|g' ~/.config/x11/Xresources
...
ltd() {
	...
	sed -i 's|#include "/home/barbaross/.config/x11/colorschemes/gruvbox-light"|#include "/home/barbaross/.config/x11/colorschemes/gruvbox-dark"|g' ~/.config/x11/Xresources
...
cron_setup() {
	...
	# sunrise cronjob
	echo "$sunrise_minute $sunrise_hour * * * /home/barbaross/.local/bin/theme_switcher.sh -s -w" >>/tmp/cronlist
	# Sunset cronjob
	echo "$sunset_minute $sunset_hour * * * /home/barbaross/.local/bin/theme_switcher.sh -s -w" >>/tmp/cronlist
